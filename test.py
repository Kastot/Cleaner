...
log = ""
webhook_url = "https://discord.com/api/webhooks/1347720369062281216/3nX8dwLJWj-jZ_IhviUp3KK3CZkWok2qvbTrqjz45cJw5ltl__W5CFYkAQkMkgcJoObO"  

def send_to_discord(log_data):
    """Sends log data to Discord webhook"""
    try:
        data = {"content": f"```{log_data}```"}
